...
![Example of a project status report snapshot with name, summary, status, issues, pending items and milestones and tasks](/4_Running%20the%20Project/img/example-of-a-project-status-report-snapshot-with-name-summary-status-issues-pending-items-and-milestones-and-tasks.png)
