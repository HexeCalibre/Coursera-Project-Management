...
![Icon for Ask](/4_Running%20the%20Project/img/icon-for-ask.png)
...
![Line graph trending downwards for gym memberships declining month-over-month](/4_Running%20the%20Project/img/line-graph-trending-downwards-for-gym-memberships-declining-month-over-month.png)

Another part of the **Ask** stage is identifying your stakeholders and understanding their expectations. There can be lots of stakeholders on a project, and each of them can make decisions, influence actions, and weigh in on strategies. Each stakeholder will also have specific goals they want to meet. It is pretty common for a stakeholder to come to you with a problem that needs solving. But before you begin your analysis, you need to be clear about what they are asking of you. For example, if your manager assigns you a project related to analyzing the gym’s business risk, it would be a good idea to confirm whether they want you to analyze <u>all</u> types of risks that could affect the gym or just risks related to weather or seasonal trends.

![Icon for prepare](/4_Running%20the%20Project/img/icon-for-prepare.png)
...
![Icon for Process](/4_Running%20the%20Project/img/icon-for-process.png)
...
![icon for analyze](/4_Running%20the%20Project/img/icon-for-analyze.png)
...
![Icon for Share](/4_Running%20the%20Project/img/icon-for-share.png)
...
![Icon for Act](/4_Running%20the%20Project/img/icon-for-act.png)
