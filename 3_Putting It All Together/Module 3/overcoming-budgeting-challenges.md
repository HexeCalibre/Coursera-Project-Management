...
You may encounter situations where your budget is already set <u>before</u> you even start the project. This is known as **budget pre-allocation**. Some organizations follow strict budgeting cycles, which can lead to cost estimations taking place before the scope of the project is completely defined.  
...
**Scope creep** is when changes, growth, and other factors affect the project’s scope at any point <u>after</u> the project begins. Scope creep causes additional work that wasn’t planned for, so scope creep can also impact your budget. 
